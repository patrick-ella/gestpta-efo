...
const ExtrantWizard = ({ activiteId, activites, open, onClose, onCreated }: Props) => {
  ...
  // Reference is auto-generated by DB trigger — no manual input needed
  ...
  const canProceedStep1 = libelle.trim() && indicateur.trim();
  ...
  const handleCreate = async () => {
    try {
      ...
      toast.success(`✅ Extrant créé. Les références ont été réorganisées automatiquement.`);
      onCreated();
      onClose();
    } catch (err: any) {
        ...
        {step === 1 && (
          <div className="space-y-4">
            <div className="rounded-lg border border-border bg-muted/30 p-3">
              <p className="text-xs text-muted-foreground">ℹ️ La référence (E1, E2…) sera attribuée automatiquement selon l'ordre dans l'activité.</p>
            </div>
